...
public class CreateJobDeatils {
    ...
    public CreateJobDeatils() {
    }

    public CreateJobDeatils(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id,
